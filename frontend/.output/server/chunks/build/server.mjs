...
import { c as createError$1, m as sanitizeStatusCode, n as createHooks, t as toRouteMatcher, o as createRouter$1 } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-CuRjwnn4.mjs');
...
const unhead_bx9oZmEWLb = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "location",
    path: "/:location()",
    component: () => import('./_location_-CXJ56SKD.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C4ffWwRX.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_6VGRtm0fDp = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_bx9oZmEWLb,
  plugin,
  revive_payload_server_6VGRtm0fDp,
  components_plugin_KR1HBZs4kY
];
const layouts = {
  default: () => import('./default-liRNe_IF.mjs').then((m) => m.default || m)
};
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_sass@1.77.8_vite@5.4.2/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-eXYWns1b.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-sDuBVG1c.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_sass@1.77.8_vite@5.4.2/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_sass@1.77.8_vite@5.4.2/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, useNuxtApp as a, encodePath$1 as b, useRuntimeConfig as c, defu as d, entry$1 as default, encodeParam$1 as e, asyncDataDefaults as f, createError as g, hasProtocol as h, br as i, joinURL as j, useRouter as k, parseQuery$1 as l, nuxtLinkDefaults as m, navigateTo as n, withTrailingSlash as o, parseURL$1 as p, withoutTrailingSlash as q, resolveRouteObject as r, injectHead as s, resolveUnrefHeadInput as t, useRoute$1 as u, withLeadingSlash as w };
