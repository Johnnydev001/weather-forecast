...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="summary-container" data-v-96b9a669><h3 title="Temperature. Units - metric: Celsius" class="temperature" style="${ssrRenderStyle({ color: temperature.value && temperature.value > 18 ? "orange" : "rgb(100, 177, 255)" })}" data-v-96b9a669>${ssrInterpolate(temperature.value)}\xBA </h3><div class="feels-like-temperature-container" data-v-96b9a669><span data-v-96b9a669>Feels like:</span><h4 title="Feels like temperature. Units - metric: Celsius" class="feels-like-temperature" style="${ssrRenderStyle({ color: feelsLikeTemperature.value && feelsLikeTemperature.value > 18 ? "orange" : "rgb(100, 177, 255)" })}" data-v-96b9a669>${ssrInterpolate(feelsLikeTemperature.value ? feelsLikeTemperature.value + "\xBA" : "0\xBA")}</h4></div></section><article class="weather-container" data-v-96b9a669><div class="condition-container" data-v-96b9a669><div class="condition" title="The current wind speed in km/h" data-v-96b9a669>`);
...
//# sourceMappingURL=overlay-BOqJpdhM.mjs.map
