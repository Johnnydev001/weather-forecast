import { computed, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref, isRef, defineComponent, provide, createElementBlock, useAttrs, mergeProps, useSSRContext, watch, withAsyncContext } from "vue";
...
import { u as useHead } from "./vue.65b7bcda-CuxoPTaZ.js";
import { a as useRequestEvent, h as hasProtocol, w as withLeadingSlash, j as joinURL, p as parseURL, d as defu, e as encodePath, b as encodeParam, c as useNuxtApp, f as useRuntimeConfig, g as asyncDataDefaults, i as createError, _ as _export_sfc, u as useRoute } from "../server.mjs";
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import("./index-CLRNvoHr.js").then((r) => r.imageMeta);
...
const ipxStaticRuntime$KdcD3ymjWr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
_sfc_main$9.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+image@1.8.1/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
const getImageUrlByWeatherStatus = (weatherMainStatus, isIcon) => {
  switch (weatherMainStatus && (weatherMainStatus == null ? void 0 : weatherMainStatus.toLowerCase())) {
    case "clouds":
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "forecast-item" }, _attrs))} data-v-9b06f2ff><div class="summary" data-v-9b06f2ff>`);
      ...
      _push(`<div style="${ssrRenderStyle({ display: "flex", columnGap: "0.5rem", alignItems: "center" })}" data-v-9b06f2ff><span data-v-9b06f2ff>Day:</span><time${ssrRenderAttr("datetime", new Date(((_e = props == null ? void 0 : props.item) == null ? void 0 : _e.dt) * 1e3).toDateString())} data-v-9b06f2ff>${ssrInterpolate(new Date(((_f = props == null ? void 0 : props.item) == null ? void 0 : _f.dt) * 1e3).getDate())}</time></div><span data-v-9b06f2ff>${ssrInterpolate(("capitalizeWord" in _ctx ? _ctx.capitalizeWord : unref(capitalizeWord))((_h = (_g = props == null ? void 0 : props.item) == null ? void 0 : _g.weather[0]) == null ? void 0 : _h.description))}</span></div><div class="condition-container" data-v-9b06f2ff><div class="condition" data-v-9b06f2ff><span data-v-9b06f2ff>Min:</span><div class="value" data-v-9b06f2ff><span style="${ssrRenderStyle({ color: ((_j = (_i = props == null ? void 0 : props.item) == null ? void 0 : _i.temp) == null ? void 0 : _j.min) > 18 ? "orange" : "#ffffff", display: "flex", columnGap: "0.25rem", fontWeight: 800 })}" data-v-9b06f2ff><span data-v-9b06f2ff>${ssrInterpolate((_l = (_k = props == null ? void 0 : props.item) == null ? void 0 : _k.temp) == null ? void 0 : _l.min)}</span><span data-v-9b06f2ff>ºC</span></span></div></div><div class="condition" data-v-9b06f2ff><span data-v-9b06f2ff>Max:</span><div class="value" data-v-9b06f2ff><span style="${ssrRenderStyle({ color: ((_n = (_m = props == null ? void 0 : props.item) == null ? void 0 : _m.temp) == null ? void 0 : _n.max) > 18 ? "orange" : "#ffffff", display: "flex", columnGap: "0.25rem", fontWeight: 800 })}" data-v-9b06f2ff><span data-v-9b06f2ff>${ssrInterpolate((_p = (_o = props == null ? void 0 : props.item) == null ? void 0 : _o.temp) == null ? void 0 : _p.max)}</span><span data-v-9b06f2ff>ºC</span></span></div></div></div></div>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9b06f2ff"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "forecast-container" }, _attrs))} data-v-e7d7dc4e><h4 class="title" data-v-e7d7dc4e> Next 5 days forecast: </h4><ul class="list" data-v-e7d7dc4e><!--[-->`);
      ssrRenderList(unref(weatherForecast), (item) => {
        _push(`<li data-v-e7d7dc4e>`);
...
const WeatherForecast = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e7d7dc4e"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const handleWeatherRequest = async () => {
      ...
      try {
        ...
        if (error == null ? void 0 : error.value) {
          weatherForecastErrorMessage.value = ((_a2 = error == null ? void 0 : error.value) == null ? void 0 : _a2.statusMessage) ?? "Failed to get the weather forecast data";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-96b9a669><section class="sub-container" data-v-96b9a669>`);
      if (weatherForecastErrorMessage.value) {
        _push(`<aside role="alert" class="error-msg" data-v-96b9a669>${ssrInterpolate(weatherForecastErrorMessage.value)}</aside>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="location-container" data-v-96b9a669><div data-v-96b9a669><span class="location-city" data-v-96b9a669>${ssrInterpolate(city.value ? city.value + ", " : "")}</span><span class="location-country" data-v-96b9a669>${ssrInterpolate(country.value)}</span></div><span class="date" data-v-96b9a669>${ssrInterpolate(formatedTodayDate.value)}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        class: "weather-illustration",
        src: unref(iconByWeatherStatus),
      ...
      _push(`<section class="summary-container" data-v-96b9a669><h3 title="Temperature. Units - metric: Celsius" class="temperature" style="${ssrRenderStyle({ color: temperature.value && temperature.value > 18 ? "orange" : "rgb(100, 177, 255)" })}" data-v-96b9a669>${ssrInterpolate(temperature.value)}º </h3><div class="feels-like-temperature-container" data-v-96b9a669><span data-v-96b9a669>Feels like:</span><h4 title="Feels like temperature. Units - metric: Celsius" class="feels-like-temperature" style="${ssrRenderStyle({ color: feelsLikeTemperature.value && feelsLikeTemperature.value > 18 ? "orange" : "rgb(100, 177, 255)" })}" data-v-96b9a669>${ssrInterpolate(feelsLikeTemperature.value ? feelsLikeTemperature.value + "º" : "0º")}</h4></div></section><article class="weather-container" data-v-96b9a669><div class="condition-container" data-v-96b9a669><div class="condition" title="The current wind speed in km/h" data-v-96b9a669>`);
      _push(ssrRenderComponent(WindIcon, null, null, _parent));
      _push(`<div class="value" data-v-96b9a669><span class="title" data-v-96b9a669>Wind speed</span><span data-v-96b9a669>${ssrInterpolate(windSpeed.value)} KM/H</span></div></div><div class="condition" title="The current humidity of the air in %" data-v-96b9a669>`);
      _push(ssrRenderComponent(HumidityIcon, null, null, _parent));
      _push(`<div class="value" data-v-96b9a669><span class="title" data-v-96b9a669>Humidity</span><span data-v-96b9a669>${ssrInterpolate(humidity.value)} %</span></div></div><div class="condition" title="Atmospheric pressure on the sea level, hPa" data-v-96b9a669>`);
      _push(ssrRenderComponent(PressureIcon, null, null, _parent));
      _push(`<div class="value" data-v-96b9a669><span class="title" data-v-96b9a669>Pressure</span><span data-v-96b9a669>${ssrInterpolate(pressure.value)} hPa</span></div></div><div class="condition" title="The current UV index" data-v-96b9a669>`);
      _push(ssrRenderComponent(UVIndexIcon, null, null, _parent));
      _push(`<div class="value" data-v-96b9a669><span class="title" data-v-96b9a669>UV index</span><span data-v-96b9a669>${ssrInterpolate(uvIndex.value)}</span></div></div></div>`);
      if ((_a2 = unref(weatherForecast)) == null ? void 0 : _a2.length) {
        _push(`<div data-v-96b9a669>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-96b9a669"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "hero-container" }, _attrs))}>`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<dialog${ssrRenderAttrs(mergeProps({
    ...
    open: "true",
    class: "overlay",
    "aria-label": "generic overlay"
  }, _attrs))}><section aria-label="overlay content"><h1 class="title">Loading content...</h1><a href="/" class="retry-btn" role="button"> Retry </a></section></dialog>`);
}
...
//# sourceMappingURL=overlay-qxE25JXI.js.map
